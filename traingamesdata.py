...
# In[68]:
feature_name_list=['Dev','Pub', 'IP', 'Date', 'Gap', 'PlayerType', 'Price', 'IMDB*', 'Rawg', 'Action', 'ActionAdventure', 'Role-Playing','Strategy', 'Adventure', 'First-Person', 'Fighting', 'Puzzle', 'Sandbox', 'Defense', 'MassivelyMultiplayer','Arcade','Sci-Fi','Combat','Driving', 'PC', 'PS4', 'XBOX', 'NS', 'Youtube', 'Twitch', 'UserScore','CriticScore','Ratings','Media','SteamCCU','SteamComments', 'SteamFollowers','Vgtime*']
...
plot_importance(model, importance_type='weight', max_num_features=32)
plt.show()
